...
Worked on migrating existing Next.js application to Micro frontend architecture for POC.`,
  },
    {
      ...
      description: `Developed accessible React component libraries using RJSF, MUI, and custom UI patterns for a healthcare client, ensuring compliance with WCAG accessibility standards.
