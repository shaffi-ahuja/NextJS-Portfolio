const ShaffiAhuja = {
  ...
  AboutMe: {
    ...
    passion: {
      ...
      passionDescription:
        "I care deeply about the details that make a product feel great — perceived performance, accessibility, and design consistency. Frontend isn't just presentation to me; it's the product.",
    },
    skills: [
      "react",
      "typescript",
  ...
  Projects: [
    {
      ...
      githubUrl: "https://github.com/shaffi-ahuja/NextJS-Portfolio",
    },
    {
      icon: "/pitch.png",
