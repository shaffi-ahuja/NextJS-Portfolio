...
Concurrently, actively involved in the renement and augmentation
of REST APIs constructed using the .Net Core, contributing to the
enhancement of overall system functionality.
Instrumental in incident management, demonstrating
comprehensive knowledge of project architecture and workows to
ensure eective issue resolution.
Proactively participating in quarterly and sprint planning meetings,
actively contributing to requirement grooming processes.
Additionally, conducting thorough end-to-end analysis for new
implementations, emphasizing a holistic approach to project
...
Contributed signicantly throughout the entire development
lifecycle of a Visitor Management System, eectively overseeing and
controlling visitor access to various commercial and residential
premises.
During the challenging period of the COVID-19 pandemic,
implemented crucial functionalities within the systems to
proactively control and manage access in adherence to health and
