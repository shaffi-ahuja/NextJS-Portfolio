        ...
        <div className='flex gap-4 md:order-last'>
          {github && (
            <Link
              ...
              aria-label={`${FirstName}'s GitHub profile (opens in new tab)`}
              className="transition-transform hover:scale-110 focus-visible:scale-110"
            >
              <FaGithub className="footer-icons hover:text-white transition-colors" />
            </Link>
          )}
          {linkedin && (
            <Link
              ...
              target="_blank"
              rel="noopener noreferrer"
              aria-label={`${FirstName}'s LinkedIn profile (opens in new tab)`}
              className="transition-transform hover:scale-110 focus-visible:scale-110"
            >
              <BsLinkedin className="footer-icons hover:text-[#0a66c2] hover:bg-white hover:rounded-sm transition-colors" />
            </Link>
          )}
          {leetcode && (
            <Link
