...
export default function UserForm() {
  ...
  const validate = useCallback((): boolean => {
    ...
    form.workExperiences.forEach((w, i) => {
      ...
      if (!w.startYear.trim()) e[`work_start_${i}`] = 'Start year is required';      if (!w.description.trim()) e[`work_desc_${i}`] = 'Description is required';
    });
    setErrors(e);
            ...
            <div className="input-div">
              <div className="flex items-center justify-between mt-3">
                ...
                <button
                  ...
                  onClick={() => updateWork(i, 'isCurrentJob', !work.isCurrentJob)}
                ...
                >
                  <span className={`inline-block h-4 w-4 transform rounded-full bg-white dark:bg-black shadow transition-transform ${work.isCurrentJob ? 'translate-x-6' : 'translate-x-1'}`} />
                </button>
              </div>
            </div>
