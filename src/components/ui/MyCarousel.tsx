    ...
    return (
        <>
            ...
            <div className='dots-container'>
                <PiCircleFill className={`size-2 ${index == 0 ? "fill-current" : "fill-[#808080]"}`} />
                <PiCircleFill className={`size-2 ${index == 1 ? "fill-current" : "fill-[#808080]"}`} />
                <PiCircleFill className={`size-2 ${index == 2 ? "fill-current" : "fill-[#808080]"}`} />
            </div>
        </>
    )
}
