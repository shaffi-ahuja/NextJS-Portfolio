...
export const WorkExperienceSchema = z.object({
  ...
  endYear: z.string().default("Present"), // "Present" or a year string
...
export const PortfolioSchema = z.object({
  ...
  Intro: z.object({
    ...
    profileImage: z.string().optional().default(""), // base64 data URL
  }),
  ...
  AboutMe: z.object({
    ...
    passion: z.object({
      ...
      description: z.string().min(20, "Passion description must be at least 20 characters"),
    }),
  ...
  Footer: z.object({
    FirstName: z.string(),
    LastName: z.string(),
    github: z.string().url("Must be a valid URL").or(z.literal("")).optional().default(""),
    linkedin: z.string().url("Must be a valid URL").or(z.literal("")).optional().default(""),
    leetcode: z.string().url("Must be a valid URL").or(z.literal("")).optional().default(""),
  }),
});
...
// Form state type - what the form collects before full validation
...
// Convert flat form data into the nested Portfolio shape
export function formDataToPortfolio(data: PortfolioFormData): Portfolio {
  return {
    ...
    ContactMe: {
      contactMeFor: data.contactMeFor,
      email: data.email,
    },
    Projects:
